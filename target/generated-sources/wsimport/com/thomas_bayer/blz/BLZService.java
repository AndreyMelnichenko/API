    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.thomas_bayer.blz.BLZService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.thomas_bayer.blz.BLZService.class.getResource(".");
            url = new URL(baseUrl, "http://thomas-bayer.com/axis2/services/BLZService?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://thomas-bayer.com/axis2/services/BLZService?wsdl', retrying as a local file");
